...
public class FirefoxSeleniumTest extends WebDriverSetUp{
    @Test
    public void checkTitle(){
        driver.get("http://localhost:4000/");
        String title = driver.getTitle();
        Assert.assertEquals(title, "Socket.io Chat", "checking page title failed");
    }
    ...
    public void goToChatWithName() {
        ...
        join.click();
        Assert.assertTrue(true, "goToChatWithName function faled");
    }
