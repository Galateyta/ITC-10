     ...
     QObject* view, QString style, QDomElement e)
{
    ...
    if (parentType == EElementType::Div)
    {
        ...
        {
            QByteArray temp = mDownloadManager->startImgSendServer(src);
            QPixmap pix;
...
void MainWindow::onDownloadFinished(QByteArray data)
{
    QDomDocument doc;
    doc.setContent(data);
...
void MainWindow::onXmlPageDownloadFinished(void* nulptr, QByteArray data)
{
    QDomDocument d;
    d.setContent(data);
