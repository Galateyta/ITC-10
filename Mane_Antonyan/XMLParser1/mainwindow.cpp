...
void MainWindow::parseElement(QDomElement e, QObject* parent, EElementType parentType)
{
    ...
    switch (type) {
        ...
        {
            createInput(tagType, parentType, view, style, parent, value);
            break;
        }
...
void MainWindow::createInput(QString tagType, EElementType parentType,
     QObject* view, QString style, QObject* parent, QString value)
{
    if (tagType == "text")
    {
        createInputText(parentType, view, style, parent);
...
void MainWindow::createInputText(EElementType parentType,
     QObject* view, QString style, QObject* parent)
{
    if (parentType == EElementType::Div)
    {
         view = new QLineEdit();
