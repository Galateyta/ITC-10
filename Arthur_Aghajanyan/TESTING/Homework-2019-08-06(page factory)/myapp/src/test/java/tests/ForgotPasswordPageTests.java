...
public class ForgotPasswordPageTests extends BasePage {
    ...
    public void createWebDriver() {
        try {
            if (!BasePage.driver.findElement(By.xpath(ForgotPasswordConstants.forgotPasswordPageResetButton)).isDisplayed()) {
                throw new NoSuchElementException("");
            }
            pageInstance = ForgotPasswordPage.getInstance();
        } catch (Exception e) {
    ...
    public void verifyInvalidEmailAddressFunctionality() {
        ...
        Assert.assertTrue(pageInstance.getResetButton().isDisplayed(), "Page change after inputing invalid email address!!!");
    }
