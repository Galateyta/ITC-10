...
class Login extends Component {
  constructor(props) {
    ...
    handleSubmit() {
      let registredUsersEmail = localStorage.getItem('registredUsersEmail');
      let registredUsersPassword = localStorage.getItem('registredUsersPassword');
      if (this.state.email === registredUsersEmail && this.state.password === registredUsersPassword){
