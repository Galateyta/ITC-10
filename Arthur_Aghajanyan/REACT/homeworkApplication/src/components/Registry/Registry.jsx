...
class Registry extends React.Component {
  constructor(props) {
    ...
    handleSubmit(e) {
      e.preventDefault();
        localStorage.setItem('registredUsersName', this.state.name);
        localStorage.setItem('registredUsersSurname', this.state.surname);
        localStorage.setItem('registredUsersEmail', this.state.email);
        localStorage.setItem('registredUsersPassword', this.state.password);
        localStorage.setItem('registredUsersDate', this.state.date);
          ...
          <div>
              <Container className = 'registery-page-style'>
                  <Form className = 'form-registry-inpute' onSubmit = {this.handleSubmit}>
                      ...
                      <FormGroup >
                          <Input type = 'file' name = 'file' className = 'exampleFile' required />
